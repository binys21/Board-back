...
public class FileUtils {
    ...
    //요청을 통해 전달받은 파일 저장, 파일 정보 반환하는 메서드
    public List<BoardFileDto> parseFileInfo(int boardIdx, MultipartHttpServletRequest request)
        throws Exception{
        ...
        String storedDir=uploadDir+"images\\"+now.format(dft);
